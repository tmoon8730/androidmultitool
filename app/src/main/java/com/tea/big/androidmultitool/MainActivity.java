package com.tea.big.androidmultitool;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presentTellerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                Intent intent = new Intent(view.getContext(), PresentTeller.class);
                startActivity(intent);
            }
        });

        mailAppButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
        ...
        simpleDatabaseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent intent = new Intent(view.getContext(), SimpleDatabase.class);
                startActivity(intent);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "Launching Mail App", Snackbar.LENGTH_LONG)
